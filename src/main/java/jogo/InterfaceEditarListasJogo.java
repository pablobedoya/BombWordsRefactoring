...
public class InterfaceEditarListasJogo implements ActionListener
{
	...
	public void criarInterfaceEditarListasJogo()
	{
		...
		editarPalavrasDasListas = new JButton("adicionar/remover palavras em listas j� criadas");
	...
	{
		String[] palavrasDaNovaComboBox = new String[comboBoxListasDoJogo.getItemCount() - 1];
		//esse arranjo contem as palavras atuais da combo box e não terá o nome em lista 
	...
	{
		int percorredor = 0;
		String auxiliarTroca;//auxiliar para trocas na ordenacão das palavras.
