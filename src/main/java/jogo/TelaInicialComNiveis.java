...
{
	//a tela inicial com opc�es de escolher o est�gio do curso de ingl�s e o n�vel dif�cil,m�dio ou f�cil
	...
	public void criarTelaInicial()
	{
		...
		//adicionar painel para selecionar o estágio
	...
	private JPanel criarPainelJCheckBoxEstagiosWatford()
	{
		...
		basico = new JCheckBox("b�sico");
		intermediario = new JCheckBox("intermedi�rio");
		avancado = new JCheckBox("avan�ado");
		...
		{
			grid.gridx = 0;
			grid.gridy = i + 1; //a linha 0 já possui o titulo
			grid.gridwidth = 1;
			grid.gridheight = 1;
	...
	{
		facil = new JRadioButton("f�cil (20 segundos para uma bomba explodir)");
		medio = new JRadioButton("m�dio (15 segundos para uma bomba explodir)");
		dificil = new JRadioButton("dif�cil (10 segundos para uma bomba explodir)");
		...
		JLabel titulo = new JLabel("N�vel de dificuldade:");
		titulo.setFont(new Font("Serif", Font.BOLD, 20));
		titulo.setForeground(new Color(255, 201, 14));
		JPanel painelTitulo = new JPanel();
		painelTitulo.add(titulo);
	...
	{
		//assim que o jogador clica jogar, a lista "palavras" que � a principal muda de acordo com o que foi selecionado nas Jcheckboxes
	...
	{
		//aqui será definido as configuracoes com base na dificuldade escolhida pelo jogador
