...
public class UInterfaceListaPalavras implements ActionListener, KeyListener, MouseListener
{
	...
	public int ehLabelDaListaDePalavras(Object obj)/*ve se o obj faz parte da lista 
													labelsPalavrasLista. Retorna -1 se não achar e o indice dele na lista
													caso ache*/ 
	{
	...
	//no método abaixo, a lista que está sendo visualizada será selecionada como a lista
	...
	public void removerPalavrasSelecionadas()
	{
		...
		for(int i = 0; i < this.palavrasEstaoSelecionadasNaLista.size(); i++)
		{
			...
			if(palavraEstahSelecionada == true)
			{
				...
				//essa string tem palavra e traducao, mas pra remover uma palavra soh precisamos da traducão.
	...
	{
		JLabel legendaListaAtual = new JLabel("Lista:");//so para o usuario ter nocão do que é a label lista atual
		...
		labelLegenda.setText("<html><font color='white'>Formato:</font><font color = #8bf2f8>Palavra;Tradu��o</font></html>");
