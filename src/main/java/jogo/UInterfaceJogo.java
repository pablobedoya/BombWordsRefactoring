...
public class UInterfaceJogo implements KeyListener
{
	...
	private int quantasBombasJaExplodiram; //�til para alterar a tabela que mostra as palavras erradas por um jogador
	...
	public JPanel criarCoracoesJogador1()
	{
		...
		//Criar uma label para dizer que as vidas s�o do jogador
